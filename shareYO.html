...
<head>
    ...
    <link rel="stylesheet" href="shareYO.css">
...
<body>
    ...
    <section class="Recetat">
        ...
        <div class="navbar">
            <nav class="MiniNav">
                <ul>
                    <li><a href="recipes.html">Explore</a></li>
                    <li><a href="FindRecipe.html">Find Recipes</a></li>
                    <li><a href="shareYO.html">Share Your Own</a></li>
                </ul>
            </nav>
        </div>


            <section class="ShareYourOwn">
                ...
                <div class="Perberes">
                    ...
                    <h2>Choose the ingridients you used</h2>
